# DisplayName: Jolla mimameid/@ARCH@ (release) 1
...
repo --name=adaptation-community-mimameid-@RELEASEMAJMIN@ --baseurl=http://repo.sailfishos.org/obs/nemo:/testing:/hw:/volla:/halium-mimameid:/@RELEASEMAJMIN@/sailfishos_@RELEASEMAJMIN@_@ARCH@/
...
%packages
patterns-sailfish-device-configuration-halium-mimameid
%end
...
/boot/boot.img
/etc/hw-release
droid-config-halium-mimameid-out-of-image-files
%end
